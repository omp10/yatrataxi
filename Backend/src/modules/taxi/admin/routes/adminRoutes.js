...
import {
  ...
  approveAgentWithdrawalRequest,
  deleteAppModule,
  deleteAgentNeededDocument,
  deleteBusService,
  deleteDriver,
  ...
  listAgentWalletHistory,
  adjustDriverWallet,
  listOwnerWalletHistory,
  adjustOwnerWallet,
  updateAgentNeededDocument,
  updateAppModule,
  updateAirport,
  updateAdminAccount,
  updateBusService,
...
adminRouter.post('/admin/agents', createAgent);
adminRouter.get('/admin/agents/pending', getAgents);
adminRouter.get('/admin/agents/documents', getAgentNeededDocuments);
...
adminRouter.post('/admin/wallet/agents/:id/adjust', adjustAgentWallet);
adminRouter.get('/admin/wallet/agents/:id/history', listAgentWalletHistory);
adminRouter.get('/admin/wallet/agents/withdrawals', getAgentWithdrawalRequests);
adminRouter.patch('/admin/wallet/agents/withdrawals/:id/approve', approveAgentWithdrawalRequest);
adminRouter.patch('/admin/wallet/agents/withdrawals/:id/reject', rejectAgentWithdrawalRequest);
