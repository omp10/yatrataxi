  ...
  const links = [
    {
      ...
      url: 'https://play.google.com/store/apps/details?id=com.Yatra Desk.user',
      type: 'Customer App',
    ...
    {
      id: 'driver',
      title: 'Yatra Desk Driver',
      subtitle: 'Drive and earn with Yatra Desk.',
      description: 'Join our fleet of professional drivers. Flexible hours, great earnings, and a supportive community.',
      url: 'https://play.google.com/store/apps/details?id=com.Yatra Desk.driver',
      type: 'Partner App',
  ...
  return (
    <div className="links-page-container">
      <nav className="links-nav">
        <div className="nav-container">
          <a href="/" className="nav-logo">
            <span className="logo-Yatra Desk">Yatra Desk</span><span className="logo-24">24</span>
          </a>
      ...
      <div className="links-banner">
        <img src={bannerImg} alt="Yatra Desk Banner" className="banner-image" />
        <div className="banner-gradient"></div>
      </div>

      <div className="links-content-wrapper">
        <header className="links-header">
          <h1 className="links-title">Download <span className="highlight">Yatra Desk</span></h1>
        ...
        <footer className="links-footer">
          <p>© 2026 Yatra Desk. All rights reserved.</p>
          <div className="footer-links">
            <a href="https://Yatra Desk.com" target="_blank" rel="noopener noreferrer">Visit Website</a>
