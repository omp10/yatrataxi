        ...
        items: [
          ...
          { icon: MessageCircle, label: 'Chat', path: '/admin/chat', permission: 'chat.view' },
          {
            ...
            subItems: [
              ...
              { label: 'Explore India', path: '/admin/promotions/explore-india', permission: 'promotions.view' },
            ],
          },
          {
            icon: IndianRupee,
                ...
                {isUserMenuOpen && (
                  ...
                  >
                    <div className="px-5 py-4 border-b border-slate-50 mb-2 bg-slate-50/50 rounded-t-[1.5rem]">
                       ...
                       <p className="text-[13px] font-bold text-slate-900 truncate leading-tight">{adminProfile?.email || 'root@Yatra Desk.cloud'}</p>
                    </div>
