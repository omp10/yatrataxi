...
export const adminService = {
  ...
  reviewAgent: (id, payload) => api.patch(`/admin/agents/${id}`, payload),
  adjustAgentWallet: (id, payload) => api.post(`/admin/wallet/agents/${id}/adjust`, payload),
  getAgentWalletHistory: (id) => api.get(`/admin/wallet/agents/${id}/history`),
  getAgentNeededDocuments: () => api.get('/admin/agents/documents'),
  createAgentNeededDocument: (payload) => api.post('/admin/agents/documents', payload),
  updateAgentNeededDocument: (id, payload) => api.patch(`/admin/agents/documents/${id}`, payload),
  deleteAgentNeededDocument: (id) => api.delete(`/admin/agents/documents/${id}`),
  getAgentBookings: (params = {}) => api.get('/admin/agents/bookings', { params }),
  getAgentCommissionDefaults: () => api.get('/admin/agents/commission-defaults'),
  updateAgentCommissionDefaults: (payload) => api.put('/admin/agents/commission-defaults', payload),
  getAgentWithdrawalRequests: (params = {}) => api.get('/admin/wallet/agents/withdrawals', { params }),
  approveAgentWithdrawalRequest: (id, payload = {}) => api.patch(`/admin/wallet/agents/withdrawals/${id}/approve`, payload),
  rejectAgentWithdrawalRequest: (id, payload = {}) => api.patch(`/admin/wallet/agents/withdrawals/${id}/reject`, payload),
