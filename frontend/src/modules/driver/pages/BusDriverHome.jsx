...
const BusDriverHome = () => {
  ...
  const openTicketScanPage = useCallback(() => {
    navigate('/taxi/driver/bus-home/ticket-scan');
  }, [navigate]);
    ...
    <div className="space-y-5">
      <section className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-3">
          ...
          <button
            type="button"
            onClick={openTicketScanPage}
            className="rounded-2xl bg-slate-950 p-4 text-left text-white transition hover:bg-slate-800 active:scale-[0.99]"
          >
            <p className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.16em] text-white/55"><QrCode size={14} /> Check-in</p>
            <p className="mt-2 text-sm font-black">Scan Ticket QR</p>
            <p className="mt-1 text-sm text-white/60">Mark passenger attendance</p>
          </button>
