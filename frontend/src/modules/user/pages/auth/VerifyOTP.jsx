              ...
              {otp.map((digit, index) => (
                <input
                  ...
                  className={`h-16 w-full rounded-2xl border-2 text-center text-3xl font-black transition-all outline-none ${
                    digit 
                      ? 'border-amber-500 bg-amber-50/10 text-slate-900 shadow-lg shadow-amber-100/50' 
                      : 'border-slate-100 bg-slate-50 text-slate-900 focus:border-amber-500 focus:bg-white focus:shadow-lg focus:shadow-amber-100/30'
                  }`}
                />
              ))}
            </div>
