...
import { getLocalAgentToken } from './modules/agent/services/agentService';
import './App.css';
...
const BusDriverTicketScan = lazy(() => import('./modules/driver/pages/BusDriverTicketScan'));
...
// Agent Module
const AgentShell = lazy(() => import('./modules/agent/components/AgentShell'));
const AgentLogin = lazy(() => import('./modules/agent/pages/AgentLogin'));
const AgentOtpVerification = lazy(() => import('./modules/agent/pages/AgentOtpVerification'));
const AgentOnboarding = lazy(() => import('./modules/agent/pages/AgentOnboarding'));
const AgentPendingStatus = lazy(() => import('./modules/agent/pages/AgentPendingStatus'));
const AgentHome = lazy(() => import('./modules/agent/pages/AgentHome'));
const AgentBookings = lazy(() => import('./modules/agent/pages/AgentBookings'));
const AgentReferral = lazy(() => import('./modules/agent/pages/AgentReferral'));
const AgentWalletView = lazy(() => import('./modules/agent/pages/AgentWallet'));
const AgentProfile = lazy(() => import('./modules/agent/pages/AgentProfile'));
const AgentRideBooking = lazy(() => import('./modules/agent/pages/AgentRideBooking'));
...
const AdminAgentManager = lazy(() => import('./modules/admin/pages/agents/AgentManager'));
...
const MainLayout = ({ children }) => {
  ...
  if (isAdminPath) {
    return <div className="Yatra Desk-admin-root h-screen bg-gray-50 overflow-hidden">{children}</div>;
  }

  if (isStaticPath) {
    return (
      <div className="Yatra Desk-landing-root min-h-screen bg-white">
...
const AgentProtectedRoute = () => {
  if (!getLocalAgentToken()) {
    return <Navigate to="/taxi/agent/login" replace />;
  }
        ...
        <MainLayout>
          <Suspense
            ...
            <Routes>
              ...
              <Route path="/taxi/agent/onboarding" element={<AgentOnboarding />} />
              <Route path="/taxi/agent/pending" element={<AgentPendingStatus />} />
              ...
              <Route path="/taxi/driver" element={<DriverLayout />}>
                ...
                <Route path="bus-home/ticket-scan" element={<BusDriverTicketScan />} />
              ...
              <Route element={<AgentProtectedRoute />}>
                <Route path="/taxi/agent" element={<AgentShell />}>
